<?php
/*
 Template Name: Default Template - Testimonial Form
...
if($_REQUEST['status']){
	...
	}elseif($status_msg == "Please enter correct Verification code"){
...
//error_log("Testimonial(/plugins/apptivo-business-site/inc/testimonials/templates/frontend/defaulttemplate.php) successMessage URL :- ".$actual_link);

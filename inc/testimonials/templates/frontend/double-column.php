<?php
/*
  Template Name: Double column layout - Testimonialform
...
#login-box .form_rgt_part{width:48% !important;float:right;margin-top:5px;}
...
echo '<div class="form_section" '.esc_attr($style).'>';

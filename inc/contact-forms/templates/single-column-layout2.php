...
if( ! function_exists('validator_js_call_contactform_layout2_s') ) :
	function validator_js_call_contactform_layout2_s(){
...
add_action('wp_footer',"validator_js_call_contactform_layout2_s",100);
...
do_action('apptivo_business_contact_'.esc_attr($contactform['name']).'_before_form'); //Before submit form
